	...
	class MenuActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			  ...
			  if(e.getActionCommand().equals("How to play")) {
				  new InfoDialog(_frame, "How to Play", "Moving: W A S D or UP DOWN RIGHT LEFT\nPlacing Bombs: SPACE, F", JOptionPane.QUESTION_MESSAGE);
			  }
				  
			  if(e.getActionCommand().equals("About")) {
				  new InfoDialog(_frame, "About", "Version: " + Game.VERSION + "\nPhumiapiluk Pimsen 6330300682", JOptionPane.INFORMATION_MESSAGE);
			  }
